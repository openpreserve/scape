...
public class ByteStreamInfo {
	...
	@XmlElement
	private Set<JavaDigestValue> checksums = new HashSet<JavaDigestValue>();
	 ...
	 *            details of a checksum
	 */
	public void addChecksum(JavaDigestValue checksum) {
		this.checksums.add(checksum);
	}
	...
	/**
	 * @return the set of checksums known for this byte sequence
	 */
	public Set<JavaDigestValue> getChecksums() {
	...
	JAXBContext jbc = JAXBContext
		.newInstance(ByteStreamInfo.class);
	...
	public String toString() {
		...
		for (JavaDigestValue checksum : this.checksums) {
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((this.checksums == null) ? 0 : this.checksums.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (this.checksums == null) {
			if (other.checksums != null)
				return false;
		} else if (!this.checksums.equals(other.checksums))
			return false;
	 ...
	 */
	public static ByteStreamInfo getInstance(long length, JavaDigestValue checksum) {
	 ...
	 * @return a new ByteStreamInfo instance created from the params
	 */
	public static ByteStreamInfo getInstance(long length, JavaDigestValue checksum, String mime) {
