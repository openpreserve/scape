...
SET(OpenCV_INCLUDE_DIRS /opt/include/opencv;/opt/include)
...
IF (NOT 1)
    ...
    LINK_DIRECTORIES(/opt/lib/../3rdparty/lib)
    if(WIN32)
        LINK_DIRECTORIES(""/3rdparty/lib)
    else()
        LINK_DIRECTORIES(/opt/lib/../share/opencv/3rdparty/lib)
    endif()    
